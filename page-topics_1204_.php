	...
	<div class="container container_two_column">
		<?php while ( have_posts() ) : the_post(); ?>
				...
				<div class="entry-content">
                    ...
                    <h2 class="rec-title topics_single_title"><a href="<?php the_permalink();?>"><?php //the_title(); ?><?php
...
?></a></h2><div class="single_list_data_wrap"><span class="single_date single_date_02">公開：<?php the_time('Y年m月d日'); ?></span></div>
                ...
                <div class="sigle-btn-cont hover-opa">
                    <a href="<?php bloginfo('url'); ?>/contact/"><span class="sigle-btn-cont-inner">お問い合わせはこちら</span></a>
                </div>
