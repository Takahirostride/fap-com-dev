<?php 
    ...
    function theme_plugin_styles() {
         wp_enqueue_style( 'plugin-child', get_stylesheet_directory_uri() . '/css/slick.css' );
         wp_enqueue_style( 'plugin-child', get_stylesheet_directory_uri(). '/css/slick-theme.css' );
    }
