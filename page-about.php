        ...
        <div class="row">
            <div class="col-lg-6">
                <figure class="d-block mx-auto text-center">
                    <img src="https://fa-products.jp/syst/wp-content/uploads/2019/03/company_img23-32.png" alt="" class="wp-image-939 w-100 image-fluid rounded">
                    <figcaption>代表取締役会長 天野 眞也　代表取締役社長 貴田 義和</figcaption>
                </figure>
            </div>
            <div class="col-lg-6">
                <p class="h6 mb-5">
...
<section class="page_block bg_g mb-5 py-5">
